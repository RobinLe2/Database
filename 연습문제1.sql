...
/*
    ...
    9        10     올림픽 챔피언
*/
SELECT  o.order_id AS 주문번호, o.book_id AS 책번호, b.book_name AS 책이름
FROM tbl_order o
JOIN tbl_book b
...
*/
SELECT o.order_id AS 구매번호 , c.cust_name AS 구매자 , b.book_name AS 책이름 , o.amount * b.price AS 총구매액, ordered_at AS 주문일자
FROM tbl_order o 
...
FROM tbl_book b
LEFT OUTER JOIN tbl_order o ON o.book_id = b.book_id
